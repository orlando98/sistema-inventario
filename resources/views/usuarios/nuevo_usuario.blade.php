...
@section('title-content' , 'Crear nuevo usuario')
@section('content')
@csrf
...
<div class="box">
    <div class="card">
        ...
        <div class="card-footer	text-right">
            <div class="d-flex">
                <button type="button" class="btn btn-success ml-auto" id="btnCreateRegister"><i class="fas fa-check"></i>&nbsp; Crear usuario</button>
            </div>
        </div>
    </div>
</div>
