...
@section('title-content' , 'Salida de productos')
@section('content')
...
<div class="page-header">
    <div class="row align-items-center">
        <div class="col-auto">
            <h2 class="page-title">Salida de productos</h2>
        </div>
    </div>
                                ...
                                <optgroup label="{{mb_strtoupper($item->lugar)}}">
                                    @foreach ($pacientes as $item2)
                                        @if ($item2->area_fk == $item->idArea)
                                            <option value="{{$item2->idPaciente}}-{{$item->idArea}}">{{mb_strtoupper($item->lugar)}} | {{mb_strtoupper($item2->nombres)}} {{mb_strtoupper($item2->apellidos)}}</option>
                                        @endif
                                    @endforeach
                                </optgroup>
                            @endforeach
