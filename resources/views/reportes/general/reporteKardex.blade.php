...
@section('title-content' , 'Reporte kardex')
@section('content')
<!-- Page title -->
...
<script>
    ...
    function searchFilters(){
        ...
        if(area == "success"){
            ...
            fetch(`/filtro/reporte/kardex/parametros/${fecha_inicio}/${fecha_fin}/${area}`)
            .then(response => response.json()).then(data => {
                ...
                if(data.productos.length > 0){
                    ...
                    var btnPDF = document.getElementById("btn_pdf");
                        btnPDF.setAttribute('href', `/PDF/reporte/kardex/${fecha_inicio}/${fecha_fin}/${area}`)
