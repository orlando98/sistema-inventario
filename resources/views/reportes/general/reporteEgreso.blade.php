...
@section('title-content' , 'Reporte egresos')
@section('content')
<!-- Page title -->
...
<script>
    ...
    function searchFilters(){
        ...
        if(area == "success"){
            ...
            fetch(`/filtro/reporte/egreso/parametros/${fecha_inicio}/${fecha_fin}/${area}`)
            .then(response => response.json()).then(data => {
                ...
                if(data.length > 0){
                    ...
                    var btnPDF = document.getElementById("btn_pdf");
                        btnPDF.setAttribute('href', `/PDF/movimiento/egreso/${fecha_inicio}/${fecha_fin}/${area}/${pacientes}`)
