...
<script>
    ...
    function searchFilters(){
        ...
        if(area == "success"){
            ...
            fetch(`/filtro/reporte/kardex/centro/parametros/${fecha_inicio}/${fecha_fin}/${area}`)
            .then(response => response.json()).then(data => {
                ...
                if(data.productos.length > 0){
                    ...
                    var btnPDF = document.getElementById("btn_pdf");
                        btnPDF.setAttribute('href', `/PDF/reporte/kardex/centro/${fecha_inicio}/${fecha_fin}/${area}`)
