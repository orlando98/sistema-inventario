...
@section('title-content' , 'Reporte ingreso (Centro)')
@section('content')
<!-- Page title -->
...
<script>
    ...
    function searchFilters(){
        ...
        if(area == "success"){
            ...
            fetch(`/filtro/reporte/ingreso/centro/parametros/${fecha_inicio}/${fecha_fin}/${area}`)
            .then(response => response.json()).then(data => {
                ...
                if(data.length > 0){
                    ...
                    var btnPDF = document.getElementById("btn_pdf");
                        btnPDF.setAttribute('href', `/PDF/movimiento/ingreso/centro/${fecha_inicio}/${fecha_fin}/${area}`)
